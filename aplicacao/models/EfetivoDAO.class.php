...
class EfetivoDAO extends AbstractModel
{
    ...
    const QUERY_UPDATE = "UPDATE militar SET id_post_grad=:id_post_grad, id_esp=:id_esp, id_quadro=:id_quadro, id_secao=:id_secao, saram=:saram, nome_completo=:nome_completo, nome_guerra=:nome_guerra, situacao=:situacao, ramal=:ramal, rtcaer=:rtcaer, data_nasc=:data_nasc, data_ult_prom=:data_ult_prom, email=:email, antiguidade_turma=:antiguidade_turma WHERE id_militar=:id_militar";
