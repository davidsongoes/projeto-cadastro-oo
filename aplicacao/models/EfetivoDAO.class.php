...
{
    const QUERY_INSERT = "INSERT INTO militar (saram, nome_completo, id_posto_grad, id_esp, id_quadro, id_secao, nome_guerra, situacao, ramal, data_nasc, data_ult_prom, email, antiguidade_turma, ativo) VALUES ( :saram, :nome_completo, :id_post_grad, :id_esp, :id_quadro, :id_secao, :nome_guerra, :situacao, :ramal, :data_nasc, :data_ult_prom, :email, :antiguidade_turma, 1)";
