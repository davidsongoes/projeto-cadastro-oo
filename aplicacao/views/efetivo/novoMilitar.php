        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control datepicker" id="data_nascimento" placeholder="Data de Nascimento" name="data_nascimento" required="required" value="<?php echo $efetivo->data_nascimento?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="ramal" placeholder="Ramal" name="ramal" required="required" value="<?php echo $efetivo->ramal?>">
                    </div>
                </div>
                <div class="form-group">
