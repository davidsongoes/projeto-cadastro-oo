            ...
            <div class="container-fluid margem_direita">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Detalhes
                        - <?php echo $efetivo->posto_graduacao . ' ' . utf8_encode($efetivo->nome_guerra) ?></li>
                </ol>
                <h1>Detalhes do Militar</h1>
                <div class="row">
                    <img src="../../../fotos/<?php echo $efetivo->posto_graduacao . '_' . utf8_encode($efetivo->nome_guerra) . '.jpg' ?>"
