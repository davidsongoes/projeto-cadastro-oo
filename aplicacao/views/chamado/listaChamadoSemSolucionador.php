...
<div class="row">
    ...
    <div class="col-lg-9">
        <h1>Chamados em Aberto sem solucionador</h1><br/>
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            <a class="btn btn-success" href="index.php?c=chamado&acao=resolverChamado&id=<?php echo $chamado->id;?>">Adicionar solucionador</a>
        </td>
    </tr>
